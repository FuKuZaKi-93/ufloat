...
class Ufloat:
    ...
    def __str__(self):
        ...
        """分子の文字列"""
        for i in range(len(self.unit[0][len(self.unit[0])])):    #[文字列]は必ず最後はなのでlen(unit[0])番目
    ...
    def __flaot__(self):
        return float.__flaot__(self.value)
    ...
    def __mul__(self, other):
        ...
        """分母分子の単位被り削除"""
        for i in range(min(len(self.unit[0][len(self.unit[0])]), len(other.unit[1][len(other.unit[1])]))):
            if len(self.unit[0][len(self.unit[0])]) <= len(other.unit[1][len(other.unit[1])]):
                for j in range(len(self.unit[0][len(self.unit[0])])):
                    if self.unit[0][len(self.unit[0])][j] in len(other.unit[1][len(other.unit[1])]):
                        del self.unit[0][len(self.unit[0])][j]
                        del other.unit[1][other.unit[1].index(self.unit[0][len(self.unit[0])][j])]
            if len(self.unit[0][len(self.unit[0])]) > len(other.unit[1][len(other.unit[1])]):
                for j in range(len(other.unit[1][len(other.unit[1])])):
                    if other.unit[1][len(other.unit[1])][j] in len(self.unit[0][len(self.unit[0])]):
                        del other.unit[1][len(other.unit[1])][j]
                        del self.unit[0][self.unit[0].index(other.unit[1][len(other.unit[1])][j])]

        for i in range(min(len(self.unit[1][len(self.unit[1])]), len(other.unit[0][len(other.unit[0])]))):
            if len(self.unit[1][len(self.unit[1])]) <= len(other.unit[0][len(other.unit[0])]):
                for j in range(len(self.unit[1][len(self.unit[1])])):
                    if self.unit[1][len(self.unit[1])][j] in len(other.unit[0][len(other.unit[0])]):
                        del self.unit[1][len(self.unit[1])][j]
                        del other.unit[0][other.unit[0].index(self.unit[1][len(self.unit[1])][j])]
            if len(self.unit[1][len(self.unit[1])]) > len(other.unit[0][len(other.unit[0])]):
                for j in range(len(other.unit[0][len(other.unit[0])])):
                    if other.unit[0][len(other.unit[0])][j] in len(self.unit[1]):
                        del other.unit[0][len(other.unit[0])][j]
                        del self.unit[1][self.unit[1].index(other.unit[0][len(other.unit[0])][j])]
        ...
        new_unit_above_ary = self.unit[0][len(self.unit[0])] + other.unit[0][len(other.unit[0])]
        new_unit_under_ary = self.unit[1][len(self.unit[1])] + other.unit[1][len(other.unit[1])]
    ...
    def __truediv__(self, other):
        ...
        """分母分子の単位被り削除"""
        for i in range(min(len(self.unit[0][len(self.unit[0])]), len(other.unit[0][len(other.unit[0])]))):
            if len(self.unit[0][len(self.unit[0])]) <= len(other.unit[0][len(other.unit[0])]):
                for j in range(len(self.unit[0][len(self.unit[0])])):
                    if self.unit[0][len(self.unit[0])][j] in len(other.unit[0][len(other.unit[0])]):
                        del self.unit[0][len(self.unit[0])][j]
                        del other.unit[0][other.unit[0].index(self.unit[0][len(self.unit[0])][j])]
            if len(self.unit[0][len(self.unit[0])]) > len(other.unit[1][len(other.unit[1])]):
                for j in range(len(other.unit[0][len(other.unit[0])])):
                    if other.unit[0][len(other.unit[0])][j] in len(self.unit[0][len(self.unit[0])]):
                        del other.unit[0][len(other.unit[0])][j]
                        del self.unit[0][self.unit[0].index(other.unit[0][len(other.unit[0])][j])]

        for i in range(min(len(self.unit[1][len(self.unit[1])]), len(other.unit[1][len(other.unit[1])]))):
            if len(self.unit[1][len(self.unit[1])]) <= len(other.unit[1][len(other.unit[1])]):
                for j in range(len(self.unit[1][len(self.unit[1])])):
                    if self.unit[1][len(self.unit[1])][j] in len(other.unit[1][len(other.unit[1])]):
                        del self.unit[1][len(self.unit[1])][j]
                        del other.unit[1][other.unit[1].index(self.unit[1][len(self.unit[1])][j])]
            if len(self.unit[1][len(self.unit[1])]) > len(other.unit[1][len(other.unit[1])]):
                for j in range(len(other.unit[1][len(other.unit[1])])):
                    if other.unit[1][len(other.unit[1])][j] in len(self.unit[1]):
                        del other.unit[1][len(other.unit[1])][j]
                        del self.unit[1][self.unit[1].index(other.unit[1][len(other.unit[1])][j])]
        ...
        new_unit_above_ary = self.unit[0][len(self.unit[0])] + other.unit[1][len(other.unit[1])]
        new_unit_under_ary = self.unit[1][len(self.unit[1])] + other.unit[0][len(other.unit[0])]
